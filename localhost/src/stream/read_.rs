...
pub async fn read_with_timeout(
  ...
  let mut content_length = usize::MAX-1; // todo: not sure about this default value. Safer just 0
  ...
  println!("has_content_length_header: {}", has_content_length_header); //todo: remove later
